// Forked from https://github.com/jonsequitur/Its.Cqrs/blob/master/Domain/UnitOfWork%7BT%7D.cs
...
namespace Microsoft.Its.Domain
{
    ...
    {
        private static readonly string callContextPrefix = typeof(UnitOfWork<>).Assembly.GetName().Name + ".UnitOfWork:" +
                                                           typeof(T);
        ...
        {
            get { return outer.exception; }
            private set { outer.exception = value; }
        }
        ...
        {
            get { return CallContext.LogicalGetData(callContextPrefix) as UnitOfWork<T>; }
        }
